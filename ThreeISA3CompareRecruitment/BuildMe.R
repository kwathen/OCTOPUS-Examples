...
# In this design we want to look at 3 ISAs, each ISA will have 40 patients on control and 120 on treatment.  
...
mQtyPatientsPerArm <- matrix( c( 40,120,
                                 40,120,
                                 40,120 ), nrow=3, ncol = 2, byrow =TRUE )

# The start times, in months, of all 3 ISAs are 0
vISAStartTimes     <- c(  0, 0 , 0 )  
